        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Synopses = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Details_Courses_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Courses",
                        principalColumn: "CourseId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContentTitle = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CommunityFeeds", x => x.PostId);
                    table.ForeignKey(
                        name: "FK_CommunityFeeds_Contents_ContentId",
                        column: x => x.ContentId,
                        principalTable: "Contents",
                        principalColumn: "ContentId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CommunityFeeds_Courses_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Courses",
                        principalColumn: "CourseId");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserContentCompletions", x => x.UserContentCompletionId);
                    table.ForeignKey(
                        name: "FK_UserContentCompletions_Contents_ContentId",
                        column: x => x.ContentId,
                        principalTable: "Contents",
                        principalColumn: "ContentId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserContentCompletions_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Answers_CommunityFeeds_PostId",
                        column: x => x.PostId,
                        principalTable: "CommunityFeeds",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "51662edc-2d00-4df7-98c9-5758fa0fab2e", null, "User", "USER" },
                    { "76abe203-b66c-4999-8fca-27dc785683d5", null, "Administrator", "ADMINISTRATOR" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Chapters_CourseId_ChapterOrder",
                table: "Chapters",
                columns: new[] { "CourseId", "ChapterOrder" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_CommunityFeeds_ContentId",
                table: "CommunityFeeds",
                column: "ContentId");

            migrationBuilder.CreateIndex(
                name: "IX_CommunityFeeds_CourseId",
                table: "CommunityFeeds",
                column: "CourseId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Contents_ContentId_ContentOrder",
                table: "Contents",
                columns: new[] { "ContentId", "ContentOrder" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserContentCompletions_ContentId",
                table: "UserContentCompletions",
                column: "ContentId");

            migrationBuilder.CreateIndex(
                name: "IX_UserContentCompletions_UserId",
                table: "UserContentCompletions",
                column: "UserId");
